<?php
include("header2.php");
$_SESSION['file_id']=$_REQUEST['file_id'];
...
$result = mysqli_query($con,"SELECT * FROM files where id='$_SESSION[file_id]' ") or die('Could not connect: ' . mysqli_error($con));
...
Enter Key Shown In IMage <input type='text' name='key' class='form-control'><br><br>
